function allEvents = intParFiles09(subject,numBlocks,neighpara)

%script intParFiles09
%
%
...
% make events out of the lines in the PARFILE, add some information, and append them to the parevents structure
 ...
 % fix the messed up things for this particular subject
  events(506).face=5;
  events(506).facecoordinates=events(506).recallfacecoordinates;
  events(506).rt=6920;   
  events(506).theorfacecoordinates=events(506).theorrecallfacecoordinates; 
  events(506).iscorrect=1;
  events(506).distance=0;
  events(506).theordistance=0;
  events(506).facename=events(506).recallname;
  events(506).neighbors=events(504).neighbors;
  events(506).vocalization=0;
  events(335).recallname='JOE';
  events(335).recallface=5;
  events(335).recallfacecoordinates=events(335).facecoordinates;
  events(335).iscorrect=1;
  events(335).rt=6920;
  events(335).theorrecallfacecoordinates=events(335).theorfacecoordinates;
  events(335).distance=0;
  events(335).theordistance=0;
  events(335).vocalization=0;
