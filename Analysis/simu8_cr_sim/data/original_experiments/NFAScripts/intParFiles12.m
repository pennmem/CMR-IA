...
% make events out of the lines in the PARFILE, add some information, and append them to the parevents structure
 ...
 % fix the messed up things for this particular subject
  events(356).face=9;
  events(356).facecoordinates=events(356).recallfacecoordinates;
  events(356).rt=6570;   
  events(356).theorfacecoordinates=events(356).theorrecallfacecoordinates; 
  events(356).iscorrect=1;
  events(356).distance=0;
  events(356).theordistance=0;
  events(356).facename=events(356).recallname;
  events(356).neighbors=events(355).neighbors;
  events(356).vocalization=0;
  events(30).recallname='MARK';
  events(30).recallface=9;
  events(30).recallfacecoordinates=events(30).facecoordinates;
  events(30).iscorrect=1;
  events(30).rt=6570;
  events(30).theorrecallfacecoordinates=events(30).theorfacecoordinates;
  events(30).distance=0;
  events(30).theordistance=0;
 events(30).vocalization=0;
