...
while i<=25
   ...
   eval(mystr);
   [pconf, pconf1, pconf2, b, b1, b2]=nfaAbsLagThree(events);
   conf=[conf; pconf];
   conf1=[conf1; pconf1];
   conf2=[conf2; pconf2];
   s=[s; b];
...
e = [C1(2)-C1(1) C2(2)-C2(1) C3(2)-C3(1)]/2;
e1 = [C5(2)-C5(1) C6(2)-C6(1) C7(2)-C7(1)]/2;
e2 = [C9(2)-C9(1) C10(2)-C10(1) C11(2)-C11(1)]/2;
