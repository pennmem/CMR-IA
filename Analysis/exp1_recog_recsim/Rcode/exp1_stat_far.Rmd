...
Try to combine the three cut out components. Not converge.
...
```{r}
theta <- getME(mod.wc.drop2.cut3.comb, "theta")
start_vals <- list(theta = theta)
mod.wc.drop2.cut3.comb = lmer(formula.wc.drop2.cut3.comb, data=df, start = start_vals)
summary(mod.wc.drop2.cut3.comb)
```
